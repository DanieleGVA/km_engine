        ...
        for namespace, term_key, term in terms:
            session.run(
                ...
                SET t.namespace = $namespace,
                    ...
                    t.class = $class_,
                    t.allergen_tags = $allergen_tags,
                    t.unit_weight_g = $unit_weight_g,
                    t.countable_unit = $countable_unit,
                    t.count_policy = $count_policy,
                    t.density_g_per_ml = $density_g_per_ml,
                ...
                class_=_term_value(term, "class"),
                allergen_tags=_term_value(term, "allergen_tags", default=[]) or [],
                unit_weight_g=_term_value(term, "unit_weight_g"),
                countable_unit=_term_value(term, "countable_unit"),
                count_policy=_term_value(term, "count_policy"),
                density_g_per_ml=_term_value(term, "density_g_per_ml"),
                ambiguous=bool(_term_value(term, "ambiguous", default=False)),
